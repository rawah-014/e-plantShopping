...
import { addItem } from "./CartSlice"; // ✅ adjust the path based on your project structure
...
function ProductList({ onHomeClick }) {
  ...
  const handleAddToCart = (plant) => {
    // Dispatch the plant object to Redux store
    dispatch(addItem(plant));

    // Update local state so we know this plant was added
    setAddedToCart((prev) => ({
      ...prev,
      [plant.name]: true,
    }));
